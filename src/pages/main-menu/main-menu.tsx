...
const MainMenu: FC<any> = (props) => {
    ...
    return (
        <div className={`relative min-h-screen  w-full text-white ${isMobile ? 'text-2xl flex-wrap grid grid-cols-2 gap-x-1 gap-y-1 p-1' : 'text-3xl gap-2 flex justify-between h-full'} font-serif`}>
