...
const MainMenu: FC<any> = (props) => {
    ...
    return (
        <div className={`relative h-full w-full text-white ${isMobile ? 'text-2xl flex-wrap grid grid-cols-2 gap-x-4 gap-y-4 p-3' : 'text-3xl gap-2 flex justify-between h-full'} font-serif`}>
